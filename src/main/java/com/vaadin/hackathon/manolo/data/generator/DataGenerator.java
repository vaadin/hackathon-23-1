package com.vaadin.hackathon.manolo.data.generator;

import com.vaadin.exampledata.DataType;
import com.vaadin.exampledata.ExampleDataGenerator;
import com.vaadin.flow.spring.annotation.SpringComponent;
import com.vaadin.hackathon.manolo.data.entity.SamplePerson;
import com.vaadin.hackathon.manolo.data.service.SamplePersonRepository;
    ...
    public CommandLineRunner loadData(SamplePersonRepository samplePersonRepository) {
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2022, 6, 6, 0, 0, 0));
